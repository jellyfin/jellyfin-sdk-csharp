...
namespace Jellyfin.Sdk.Generated.Songs
{
    ...
    public class SongsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.Songs.Item.WithItemItemRequestBuilder"/></returns>
        public Jellyfin.Sdk.Generated.Songs.Item.WithItemItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("itemId", position);
                return new Jellyfin.Sdk.Generated.Songs.Item.WithItemItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Songs.SongsRequestBuilder"/> and sets the default values.
        /// </summary>
