...
namespace Jellyfin.Sdk.Generated.Songs.Item.InstantMix {
    /// <summary>
    /// Builds and executes requests for operations under \Songs\{id}\InstantMix
    /// </summary>
    public class InstantMixRequestBuilder : BaseRequestBuilder {
        ...
        public InstantMixRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Songs/{id}/InstantMix{?enableImageTypes*,enableImages*,enableUserData*,fields*,imageTypeLimit*,limit*,userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="InstantMixRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InstantMixRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Songs/{id}/InstantMix{?enableImageTypes*,enableImages*,enableUserData*,fields*,imageTypeLimit*,limit*,userId*}", rawUrl) {
        }
        /// <summary>
