...
namespace Jellyfin.Sdk.Generated.System.Logs.Log
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<string?> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder.LogRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<string> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder.LogRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder.LogRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder.LogRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.System.Logs.Log.LogRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a log file.
        /// </summary>
