...
using System;
namespace Jellyfin.Sdk.Generated.System.MediaEncoder.PathNamespace {
    /// <summary>
    /// Builds and executes requests for operations under \System\MediaEncoder\Path
    /// </summary>
    public class PathRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PathRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/System/MediaEncoder/Path", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class PathRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
