...
namespace Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder.WithSegmentIdWithContainerRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder.WithSegmentIdWithContainerRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder.WithSegmentIdWithContainerRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder.WithSegmentIdWithContainerRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.WithSegmentIdWithContainerRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a video stream using HTTP live streaming.
        /// </summary>
...
#nullable restore
            ...
            public Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.EncodingContext? Context { get; set; }
...
#nullable restore
            ...
            public Jellyfin.Sdk.Generated.Audio.Item.Hls1.Item.WithSegmentIdWithContainer.SubtitleDeliveryMethod? SubtitleMethod { get; set; }
