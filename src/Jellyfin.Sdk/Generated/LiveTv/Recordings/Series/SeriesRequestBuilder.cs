...
namespace Jellyfin.Sdk.Generated.LiveTv.Recordings.Series
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder.SeriesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.SeriesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets live tv recording series.
        /// </summary>
...
#nullable restore
            ...
            public Jellyfin.Sdk.Generated.LiveTv.Recordings.Series.RecordingStatus? Status { get; set; }
