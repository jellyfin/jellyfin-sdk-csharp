...
namespace Jellyfin.Sdk.Generated.LiveTv.SeriesTimers.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.LiveTv.SeriesTimers.Item.WithTimerItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Jellyfin.Sdk.Generated.Models.SeriesTimerInfoDto?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Jellyfin.Sdk.Generated.Models.SeriesTimerInfoDto> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Jellyfin.Sdk.Generated.Models.SeriesTimerInfoDto>(requestInfo, Jellyfin.Sdk.Generated.Models.SeriesTimerInfoDto.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.LiveTv.SeriesTimers.Item.WithTimerItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.LiveTv.SeriesTimers.Item.WithTimerItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
