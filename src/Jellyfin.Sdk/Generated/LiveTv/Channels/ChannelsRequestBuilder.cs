...
namespace Jellyfin.Sdk.Generated.LiveTv.Channels {
    ...
    public class ChannelsRequestBuilder : BaseRequestBuilder {
        ...
        public ChannelsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/LiveTv/Channels{?addCurrentProgram*,enableFavoriteSorting*,enableImages*,enableImageTypes*,enableUserData*,fields*,imageTypeLimit*,isDisliked*,isFavorite*,isKids*,isLiked*,isMovie*,isNews*,isSeries*,isSports*,limit*,sortBy*,sortOrder*,startIndex*,type*,userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ChannelsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ChannelsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/LiveTv/Channels{?addCurrentProgram*,enableFavoriteSorting*,enableImages*,enableImageTypes*,enableUserData*,fields*,imageTypeLimit*,isDisliked*,isFavorite*,isKids*,isLiked*,isMovie*,isNews*,isSeries*,isSports*,limit*,sortBy*,sortOrder*,startIndex*,type*,userId*}", rawUrl) {
        }
        /// <summary>
