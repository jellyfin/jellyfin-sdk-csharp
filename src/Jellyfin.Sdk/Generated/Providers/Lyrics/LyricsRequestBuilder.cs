...
namespace Jellyfin.Sdk.Generated.Providers.Lyrics
{
    ...
    public class LyricsRequestBuilder : BaseRequestBuilder
    {
        ...
        public Jellyfin.Sdk.Generated.Providers.Lyrics.Item.WithLyricItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("lyricId", position);
                return new Jellyfin.Sdk.Generated.Providers.Lyrics.Item.WithLyricItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Providers.Lyrics.LyricsRequestBuilder"/> and sets the default values.
        /// </summary>
