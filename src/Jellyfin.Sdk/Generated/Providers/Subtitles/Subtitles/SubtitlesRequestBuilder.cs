...
namespace Jellyfin.Sdk.Generated.Providers.Subtitles.Subtitles
{
    ...
    public class SubtitlesRequestBuilder : BaseRequestBuilder
    {
        ...
        public Jellyfin.Sdk.Generated.Providers.Subtitles.Subtitles.Item.WithSubtitleItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("subtitleId", position);
                return new Jellyfin.Sdk.Generated.Providers.Subtitles.Subtitles.Item.WithSubtitleItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Providers.Subtitles.Subtitles.SubtitlesRequestBuilder"/> and sets the default values.
        /// </summary>
