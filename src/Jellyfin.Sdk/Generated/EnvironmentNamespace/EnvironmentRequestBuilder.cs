...
namespace Jellyfin.Sdk.Generated.EnvironmentNamespace {
    ...
    public class EnvironmentRequestBuilder : BaseRequestBuilder 
    {
        ...
        public DefaultDirectoryBrowserRequestBuilder DefaultDirectoryBrowser
        {
            get => new DefaultDirectoryBrowserRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The DirectoryContents property</summary>
        public DirectoryContentsRequestBuilder DirectoryContents
        {
            get => new DirectoryContentsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public NetworkSharesRequestBuilder NetworkShares
        {
            get => new NetworkSharesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The ParentPath property</summary>
        public ParentPathRequestBuilder ParentPath
        {
            get => new ParentPathRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The ValidatePath property</summary>
        public ValidatePathRequestBuilder ValidatePath
        {
            get => new ValidatePathRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
