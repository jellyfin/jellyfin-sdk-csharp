...
namespace Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder.InstantMixRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder.InstantMixRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder.InstantMixRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder.InstantMixRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.MusicGenres.Item.InstantMix.InstantMixRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Creates an instant playlist based on a given genre.
        /// </summary>
