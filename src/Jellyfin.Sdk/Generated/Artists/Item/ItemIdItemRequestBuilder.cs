...
namespace Jellyfin.Sdk.Generated.Artists.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Artists\{itemId-id}
    /// </summary>
    public class ItemIdItemRequestBuilder : BaseRequestBuilder {
        ...
        public ItemIdItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Artists/{itemId%2Did}{?userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="ItemIdItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemIdItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Artists/{itemId%2Did}{?userId*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<BaseItemDto?> GetAsync(Action<RequestConfiguration<ItemIdItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<BaseItemDto> GetAsync(Action<RequestConfiguration<ItemIdItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ItemIdItemRequestBuilderGetQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ItemIdItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
#endif
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ItemIdItemRequestBuilder WithUrl(string rawUrl) {
            return new ItemIdItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets an artist by name.
        /// </summary>
        public class ItemIdItemRequestBuilderGetQueryParameters {
