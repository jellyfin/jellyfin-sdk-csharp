...
namespace Jellyfin.Sdk.Generated.Artists.Item.Similar {
    /// <summary>
    /// Builds and executes requests for operations under \Artists\{itemId-id}\Similar
    /// </summary>
    public class SimilarRequestBuilder : BaseRequestBuilder {
        ...
        public SimilarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Artists/{itemId%2Did}/Similar{?excludeArtistIds*,fields*,limit*,userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="SimilarRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SimilarRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Artists/{itemId%2Did}/Similar{?excludeArtistIds*,fields*,limit*,userId*}", rawUrl) {
        }
        /// <summary>
        /// Gets similar items.
        /// </summary>
