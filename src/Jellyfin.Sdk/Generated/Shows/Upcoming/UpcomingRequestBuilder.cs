...
namespace Jellyfin.Sdk.Generated.Shows.Upcoming {
    ...
    public class UpcomingRequestBuilder : BaseRequestBuilder {
        ...
        public UpcomingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Shows/Upcoming{?enableImages*,enableImageTypes*,enableUserData*,fields*,imageTypeLimit*,limit*,parentId*,startIndex*,userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UpcomingRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpcomingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Shows/Upcoming{?enableImages*,enableImageTypes*,enableUserData*,fields*,imageTypeLimit*,limit*,parentId*,startIndex*,userId*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class UpcomingRequestBuilderGetRequestConfiguration : RequestConfiguration<UpcomingRequestBuilderGetQueryParameters> {
        }
    }
}
