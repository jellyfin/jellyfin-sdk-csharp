...
namespace Jellyfin.Sdk.Generated.Shows.Upcoming
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder.UpcomingRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder.UpcomingRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder.UpcomingRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder.UpcomingRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.Shows.Upcoming.UpcomingRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a list of upcoming episodes.
        /// </summary>
