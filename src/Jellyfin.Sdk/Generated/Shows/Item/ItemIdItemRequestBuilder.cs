...
namespace Jellyfin.Sdk.Generated.Shows.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Shows\{itemId-id}
    /// </summary>
    public class ItemIdItemRequestBuilder : BaseRequestBuilder {
        ...
        public ItemIdItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Shows/{itemId%2Did}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="ItemIdItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemIdItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Shows/{itemId%2Did}", rawUrl) {
        }
    }
}
