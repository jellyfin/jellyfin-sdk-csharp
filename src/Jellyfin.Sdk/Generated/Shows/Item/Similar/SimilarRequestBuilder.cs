...
namespace Jellyfin.Sdk.Generated.Shows.Item.Similar {
    /// <summary>
    /// Builds and executes requests for operations under \Shows\{Shows-id}\Similar
    /// </summary>
    public class SimilarRequestBuilder : BaseRequestBuilder {
        ...
        public SimilarRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Shows/{Shows%2Did}/Similar{?excludeArtistIds*,fields*,limit*,userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SimilarRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SimilarRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Shows/{Shows%2Did}/Similar{?excludeArtistIds*,fields*,limit*,userId*}", rawUrl) {
        }
        /// <summary>
        /// Gets similar items.
        /// </summary>
