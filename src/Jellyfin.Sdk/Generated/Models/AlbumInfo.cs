...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AlbumInfo_ArtistProviderIds? ArtistProviderIds { get; set; }
#nullable restore
#else
        public AlbumInfo_ArtistProviderIds ArtistProviderIds { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public AlbumInfo_ProviderIds? ProviderIds { get; set; }
#nullable restore
#else
        public AlbumInfo_ProviderIds ProviderIds { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"ProviderIds", n => { ProviderIds = n.GetObjectValue<AlbumInfo_ProviderIds>(AlbumInfo_ProviderIds.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<AlbumInfo_ProviderIds>("ProviderIds", ProviderIds);
