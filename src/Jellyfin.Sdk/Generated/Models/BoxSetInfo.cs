...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public BoxSetInfo_ProviderIds? ProviderIds { get; set; }
#nullable restore
#else
        public BoxSetInfo_ProviderIds ProviderIds { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="BoxSetInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BoxSetInfo CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BoxSetInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"ProviderIds", n => { ProviderIds = n.GetObjectValue<BoxSetInfo_ProviderIds>(BoxSetInfo_ProviderIds.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<BoxSetInfo_ProviderIds>("ProviderIds", ProviderIds);
