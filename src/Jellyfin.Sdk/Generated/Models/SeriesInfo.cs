...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SeriesInfo_ProviderIds? ProviderIds { get; set; }
#nullable restore
#else
        public SeriesInfo_ProviderIds ProviderIds { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="SeriesInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SeriesInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"ProviderIds", n => { ProviderIds = n.GetObjectValue<SeriesInfo_ProviderIds>(SeriesInfo_ProviderIds.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<SeriesInfo_ProviderIds>("ProviderIds", ProviderIds);
