...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="BookInfoRemoteSearchQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BookInfoRemoteSearchQuery CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BookInfoRemoteSearchQuery();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"SearchInfo", n => { SearchInfo = n.GetObjectValue<BookInfo>(BookInfo.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<BookInfo>("SearchInfo", SearchInfo);
