...
namespace Jellyfin.Sdk.Generated.Models
{
    ...
    public class MovePlaylistItemRequestDto : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.Models.MovePlaylistItemRequestDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Jellyfin.Sdk.Generated.Models.MovePlaylistItemRequestDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Jellyfin.Sdk.Generated.Models.MovePlaylistItemRequestDto();
        }
        /// <summary>
