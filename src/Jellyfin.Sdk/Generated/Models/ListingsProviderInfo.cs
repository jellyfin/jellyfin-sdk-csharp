...
namespace Jellyfin.Sdk.Generated.Models
{
    ...
    public class ListingsProviderInfo : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The ChannelMappings property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Jellyfin.Sdk.Generated.Models.NameValuePair>? ChannelMappings { get; set; }
#nullable restore
#else
        public List<Jellyfin.Sdk.Generated.Models.NameValuePair> ChannelMappings { get; set; }
#endif
...
#nullable restore
        ...
        public static Jellyfin.Sdk.Generated.Models.ListingsProviderInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Jellyfin.Sdk.Generated.Models.ListingsProviderInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "ChannelMappings", n => { ChannelMappings = n.GetCollectionOfObjectValues<Jellyfin.Sdk.Generated.Models.NameValuePair>(Jellyfin.Sdk.Generated.Models.NameValuePair.CreateFromDiscriminatorValue)?.ToList(); } },
                { "Country", n => { Country = n.GetStringValue(); } },
                { "EnableAllTuners", n => { EnableAllTuners = n.GetBoolValue(); } },
                { "EnabledTuners", n => { EnabledTuners = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "Id", n => { Id = n.GetStringValue(); } },
                { "KidsCategories", n => { KidsCategories = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "ListingsId", n => { ListingsId = n.GetStringValue(); } },
                { "MovieCategories", n => { MovieCategories = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "MoviePrefix", n => { MoviePrefix = n.GetStringValue(); } },
                { "NewsCategories", n => { NewsCategories = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "Password", n => { Password = n.GetStringValue(); } },
                { "Path", n => { Path = n.GetStringValue(); } },
                { "PreferredLanguage", n => { PreferredLanguage = n.GetStringValue(); } },
                { "SportsCategories", n => { SportsCategories = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Jellyfin.Sdk.Generated.Models.NameValuePair>("ChannelMappings", ChannelMappings);
