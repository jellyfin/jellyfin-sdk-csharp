...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="MovieInfoRemoteSearchQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static MovieInfoRemoteSearchQuery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MovieInfoRemoteSearchQuery();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"SearchInfo", n => { SearchInfo = n.GetObjectValue<MovieInfo>(MovieInfo.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<MovieInfo>("SearchInfo", SearchInfo);
