...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public PersonLookupInfo_ProviderIds? ProviderIds { get; set; }
#nullable restore
#else
        public PersonLookupInfo_ProviderIds ProviderIds { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="PersonLookupInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PersonLookupInfo CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PersonLookupInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"ProviderIds", n => { ProviderIds = n.GetObjectValue<PersonLookupInfo_ProviderIds>(PersonLookupInfo_ProviderIds.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<PersonLookupInfo_ProviderIds>("ProviderIds", ProviderIds);
