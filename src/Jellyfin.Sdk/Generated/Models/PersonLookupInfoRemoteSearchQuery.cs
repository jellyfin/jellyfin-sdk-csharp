...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="PersonLookupInfoRemoteSearchQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PersonLookupInfoRemoteSearchQuery CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PersonLookupInfoRemoteSearchQuery();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"SearchInfo", n => { SearchInfo = n.GetObjectValue<PersonLookupInfo>(PersonLookupInfo.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<PersonLookupInfo>("SearchInfo", SearchInfo);
