...
namespace Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item.WithCommandItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item.WithCommandItemRequestBuilder.WithCommandItemRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item.WithCommandItemRequestBuilder.WithCommandItemRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item.WithCommandItemRequestBuilder.WithCommandItemRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item.WithCommandItemRequestBuilder.WithCommandItemRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item.WithCommandItemRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.Sessions.Item.Playing.Item.WithCommandItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Issues a playstate command to a client.
        /// </summary>
