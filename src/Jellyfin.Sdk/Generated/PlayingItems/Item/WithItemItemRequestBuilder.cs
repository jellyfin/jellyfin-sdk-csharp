...
namespace Jellyfin.Sdk.Generated.PlayingItems.Item {
    ...
    public class WithItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/PlayingItems/{itemId}{?audioStreamIndex*,canSeek*,liveStreamId*,mediaSourceId*,playMethod*,playSessionId*,subtitleStreamIndex*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="WithItemItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/PlayingItems/{itemId}{?audioStreamIndex*,canSeek*,liveStreamId*,mediaSourceId*,playMethod*,playSessionId*,subtitleStreamIndex*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<WithItemItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default) {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/PlayingItems/{itemId}{?liveStreamId*,mediaSourceId*,nextMediaType*,playSessionId*,positionTicks*}", PathParameters);
