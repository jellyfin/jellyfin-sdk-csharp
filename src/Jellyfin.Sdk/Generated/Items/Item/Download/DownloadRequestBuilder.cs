...
namespace Jellyfin.Sdk.Generated.Items.Item.Download {
    /// <summary>
    /// Builds and executes requests for operations under \Items\{Items-id}\Download
    /// </summary>
    public class DownloadRequestBuilder : BaseRequestBuilder {
        ...
        public DownloadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/Download", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DownloadRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DownloadRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/Download", rawUrl) {
        }
        /// <summary>
