...
namespace Jellyfin.Sdk.Generated.Items.Item {
    ...
    public class WithItemItemRequestBuilder : BaseRequestBuilder 
    {
        ...
        public AncestorsRequestBuilder Ancestors
        {
            get => new AncestorsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The ContentType property</summary>
        public ContentTypeRequestBuilder ContentType
        {
            get => new ContentTypeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The CriticReviews property</summary>
        public CriticReviewsRequestBuilder CriticReviews
        {
            get => new CriticReviewsRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ExternalIdInfosRequestBuilder ExternalIdInfos
        {
            get => new ExternalIdInfosRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public IntrosRequestBuilder Intros
        {
            get => new IntrosRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The LocalTrailers property</summary>
        public LocalTrailersRequestBuilder LocalTrailers
        {
            get => new LocalTrailersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The MetadataEditor property</summary>
        public MetadataEditorRequestBuilder MetadataEditor
        {
            get => new MetadataEditorRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The PlaybackInfo property</summary>
        public PlaybackInfoRequestBuilder PlaybackInfo
        {
            get => new PlaybackInfoRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public RemoteImagesRequestBuilder RemoteImages
        {
            get => new RemoteImagesRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public SpecialFeaturesRequestBuilder SpecialFeatures
        {
            get => new SpecialFeaturesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The ThemeMedia property</summary>
        public ThemeMediaRequestBuilder ThemeMedia
        {
            get => new ThemeMediaRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The ThemeSongs property</summary>
        public ThemeSongsRequestBuilder ThemeSongs
        {
            get => new ThemeSongsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The ThemeVideos property</summary>
        public ThemeVideosRequestBuilder ThemeVideos
        {
            get => new ThemeVideosRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<BaseItemDto?> GetAsync(Action<RequestConfiguration<WithItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<BaseItemDto> GetAsync(Action<RequestConfiguration<WithItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
