...
namespace Jellyfin.Sdk.Generated.Items.Item.FileNamespace {
    /// <summary>
    /// Builds and executes requests for operations under \Items\{Items-id}\File
    /// </summary>
    public class FileRequestBuilder : BaseRequestBuilder {
        ...
        public FileRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/File", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FileRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FileRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/File", rawUrl) {
        }
        /// <summary>
