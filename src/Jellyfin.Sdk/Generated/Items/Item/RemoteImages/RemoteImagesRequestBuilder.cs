...
namespace Jellyfin.Sdk.Generated.Items.Item.RemoteImages {
    /// <summary>
    /// Builds and executes requests for operations under \Items\{Items-id}\RemoteImages
    /// </summary>
    public class RemoteImagesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new RemoteImagesRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoteImagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/RemoteImages{?includeAllLanguages*,limit*,providerName*,startIndex*,type*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RemoteImagesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RemoteImagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/RemoteImages{?includeAllLanguages*,limit*,providerName*,startIndex*,type*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class RemoteImagesRequestBuilderGetRequestConfiguration : RequestConfiguration<RemoteImagesRequestBuilderGetQueryParameters> {
        }
    }
}
