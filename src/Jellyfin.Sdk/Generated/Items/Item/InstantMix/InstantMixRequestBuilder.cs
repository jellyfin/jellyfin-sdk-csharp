...
namespace Jellyfin.Sdk.Generated.Items.Item.InstantMix {
    /// <summary>
    /// Builds and executes requests for operations under \Items\{id-id}\InstantMix
    /// </summary>
    public class InstantMixRequestBuilder : BaseRequestBuilder {
        ...
        public InstantMixRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{id%2Did}/InstantMix{?enableImageTypes*,enableImages*,enableUserData*,fields*,imageTypeLimit*,limit*,userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="InstantMixRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InstantMixRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{id%2Did}/InstantMix{?enableImageTypes*,enableImages*,enableUserData*,fields*,imageTypeLimit*,limit*,userId*}", rawUrl) {
        }
        /// <summary>
