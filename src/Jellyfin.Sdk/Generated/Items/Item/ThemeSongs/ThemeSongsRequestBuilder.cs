...
namespace Jellyfin.Sdk.Generated.Items.Item.ThemeSongs
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Jellyfin.Sdk.Generated.Models.ThemeMediaResult?> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder.ThemeSongsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Jellyfin.Sdk.Generated.Models.ThemeMediaResult> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder.ThemeSongsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder.ThemeSongsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder.ThemeSongsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.Items.Item.ThemeSongs.ThemeSongsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get theme songs for an item.
        /// </summary>
