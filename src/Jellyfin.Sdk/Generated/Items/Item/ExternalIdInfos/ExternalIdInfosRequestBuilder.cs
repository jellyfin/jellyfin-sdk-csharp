...
namespace Jellyfin.Sdk.Generated.Items.Item.ExternalIdInfos {
    /// <summary>
    /// Builds and executes requests for operations under \Items\{Items-id}\ExternalIdInfos
    /// </summary>
    public class ExternalIdInfosRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new ExternalIdInfosRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExternalIdInfosRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/ExternalIdInfos", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ExternalIdInfosRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExternalIdInfosRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Items/{Items%2Did}/ExternalIdInfos", rawUrl) {
        }
        /// <summary>
