...
namespace Jellyfin.Sdk.Generated.Users.Item.Images.Item {
    ...
    public class WithImageTypeItemRequestBuilder : BaseRequestBuilder {
        ...
        public ImageTypeItemRequestBuilder this[int position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("ImageType%2Did", position);
            return new ImageTypeItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>Gets an item from the Jellyfin.Sdk.Generated.Users.item.Images.item.item collection</summary>
        /// <param name="position">Image index.</param>
        [Obsolete("This indexer is deprecated and will be removed in the next major version. Use the one with the typed parameter instead.")]
        public ImageTypeItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            if (!string.IsNullOrWhiteSpace(position)) urlTplParams.Add("ImageType%2Did", position);
            return new ImageTypeItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public WithImageTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userId}/Images/{imageType}{?addPlayedIndicator*,backgroundColor*,blur*,cropWhitespace*,fillHeight*,fillWidth*,foregroundLayer*,format*,height*,imageIndex*,index*,maxHeight*,maxWidth*,percentPlayed*,quality*,tag*,unplayedCount*,width*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithImageTypeItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class WithImageTypeItemRequestBuilderPostRequestConfiguration : RequestConfiguration<WithImageTypeItemRequestBuilderPostQueryParameters> {
        }
    }
}
