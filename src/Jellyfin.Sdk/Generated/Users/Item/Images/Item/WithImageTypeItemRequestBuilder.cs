...
using Jellyfin.Sdk.Generated.Users.Item.Images.Item.Item;
...
using System;
namespace Jellyfin.Sdk.Generated.Users.Item.Images.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Users\{userId}\Images\{imageType}
    /// </summary>
    public class WithImageTypeItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Jellyfin.Sdk.Generated.Users.item.Images.item.item collection</summary>
        /// <param name="position">Image index.</param>
        /// <returns>A <see cref="ImageIndexItemRequestBuilder"/></returns>
        public ImageIndexItemRequestBuilder this[int position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("imageIndex%2Did", position);
            return new ImageIndexItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public WithImageTypeItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userId}/Images/{imageType}{?addPlayedIndicator*,backgroundColor*,blur*,cropWhitespace*,fillHeight*,fillWidth*,foregroundLayer*,format*,height*,imageIndex*,maxHeight*,maxWidth*,percentPlayed*,quality*,tag*,unplayedCount*,width*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="WithImageTypeItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithImageTypeItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userId}/Images/{imageType}{?addPlayedIndicator*,backgroundColor*,blur*,cropWhitespace*,fillHeight*,fillWidth*,foregroundLayer*,format*,height*,imageIndex*,maxHeight*,maxWidth*,percentPlayed*,quality*,tag*,unplayedCount*,width*}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task PostAsync(Stream body, Action<RequestConfiguration<WithImageTypeItemRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PostAsync(Stream body, Action<RequestConfiguration<WithImageTypeItemRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<WithImageTypeItemRequestBuilderDeleteQueryParameters>> requestConfiguration = default) {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/Users/{userId}/Images/{imageType}{?index*}", PathParameters);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Stream body, Action<RequestConfiguration<WithImageTypeItemRequestBuilderPostQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Stream body, Action<RequestConfiguration<WithImageTypeItemRequestBuilderPostQueryParameters>> requestConfiguration = default) {
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/Users/{userId}/Images/{imageType}{?index*}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json, application/json;profile=\"CamelCase\", application/json;profile=\"PascalCase\"");
        ...
        public class WithImageTypeItemRequestBuilderDeleteQueryParameters {
            /// <summary>(Unused) Image index.</summary>
...
#nullable restore
        ...
        /// Sets the user image.
        /// </summary>
        public class WithImageTypeItemRequestBuilderPostQueryParameters {
            /// <summary>(Unused) Image index.</summary>
            [QueryParameter("index")]
            public int? Index { get; set; }
        }
