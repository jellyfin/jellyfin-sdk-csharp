...
using System;
namespace Jellyfin.Sdk.Generated.Users.Item.Items.Root {
    /// <summary>
    /// Builds and executes requests for operations under \Users\{userId}\Items\Root
    /// </summary>
    public class RootRequestBuilder : BaseRequestBuilder {
        ...
        public RootRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userId}/Items/Root", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new RootRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RootRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userId}/Items/Root", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class RootRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
