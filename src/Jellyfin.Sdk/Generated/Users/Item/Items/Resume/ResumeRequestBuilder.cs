...
namespace Jellyfin.Sdk.Generated.Users.Item.Items.Resume {
    ...
    public class ResumeRequestBuilder : BaseRequestBuilder {
        ...
        public ResumeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userId}/Items/Resume{?enableImageTypes*,enableImages*,enableTotalRecordCount*,enableUserData*,excludeActiveSessions*,excludeItemTypes*,fields*,imageTypeLimit*,includeItemTypes*,limit*,mediaTypes*,parentId*,searchTerm*,startIndex*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="ResumeRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ResumeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Users/{userId}/Items/Resume{?enableImageTypes*,enableImages*,enableTotalRecordCount*,enableUserData*,excludeActiveSessions*,excludeItemTypes*,fields*,imageTypeLimit*,includeItemTypes*,limit*,mediaTypes*,parentId*,searchTerm*,startIndex*}", rawUrl) {
        }
        /// <summary>
