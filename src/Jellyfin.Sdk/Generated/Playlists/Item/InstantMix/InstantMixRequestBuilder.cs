...
namespace Jellyfin.Sdk.Generated.Playlists.Item.InstantMix {
    /// <summary>
    /// Builds and executes requests for operations under \Playlists\{Playlists-id}\InstantMix
    /// </summary>
    public class InstantMixRequestBuilder : BaseRequestBuilder {
        ...
        public InstantMixRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Playlists/{Playlists%2Did}/InstantMix{?enableImages*,enableImageTypes*,enableUserData*,fields*,imageTypeLimit*,limit*,userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new InstantMixRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public InstantMixRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Playlists/{Playlists%2Did}/InstantMix{?enableImages*,enableImageTypes*,enableUserData*,fields*,imageTypeLimit*,limit*,userId*}", rawUrl) {
        }
        /// <summary>
