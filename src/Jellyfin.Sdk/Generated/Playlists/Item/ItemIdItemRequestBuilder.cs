...
namespace Jellyfin.Sdk.Generated.Playlists.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Playlists\{itemId-id}
    /// </summary>
    public class ItemIdItemRequestBuilder : BaseRequestBuilder {
        ...
        public ItemIdItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Playlists/{itemId%2Did}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="ItemIdItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ItemIdItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Playlists/{itemId%2Did}", rawUrl) {
        }
    }
}
