...
using System;
namespace Jellyfin.Sdk.Generated.Notifications.Services {
    /// <summary>
    /// Builds and executes requests for operations under \Notifications\Services
    /// </summary>
    public class ServicesRequestBuilder : BaseRequestBuilder {
        ...
        public ServicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Notifications/Services", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ServicesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ServicesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Notifications/Services", rawUrl) {
        }
        /// <summary>
