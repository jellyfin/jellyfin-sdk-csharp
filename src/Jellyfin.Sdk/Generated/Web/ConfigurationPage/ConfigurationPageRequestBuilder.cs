...
namespace Jellyfin.Sdk.Generated.Web.ConfigurationPage
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<Stream?> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder.ConfigurationPageRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Stream> GetAsync(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder.ConfigurationPageRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder.ConfigurationPageRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder.ConfigurationPageRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder WithUrl(string rawUrl)
        {
            return new Jellyfin.Sdk.Generated.Web.ConfigurationPage.ConfigurationPageRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a dashboard configuration page.
        /// </summary>
