...
using Jellyfin.Sdk.Generated.Genres.Item;
...
using System;
namespace Jellyfin.Sdk.Generated.Genres
{
    /// <summary>
    ...
    public partial class GenresRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Jellyfin.Sdk.Generated.Genres.Item.GenreNameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("genreName%2Did", position);
                return new global::Jellyfin.Sdk.Generated.Genres.Item.GenreNameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult?> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Jellyfin.Sdk.Generated.Models.BaseItemDtoQueryResult> GetAsync(Action<RequestConfiguration<global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder.GenresRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Jellyfin.Sdk.Generated.Genres.GenresRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets all genres from a given item, folder, or the entire library.
        /// </summary>
