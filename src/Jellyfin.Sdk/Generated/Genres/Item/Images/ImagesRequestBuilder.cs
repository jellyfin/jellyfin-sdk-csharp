...
namespace Jellyfin.Sdk.Generated.Genres.Item.Images {
    /// <summary>
    /// Builds and executes requests for operations under \Genres\{Genres-id}\Images
    /// </summary>
    public class ImagesRequestBuilder : BaseRequestBuilder {
        ...
        public ImagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Genres/{Genres%2Did}/Images", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ImagesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ImagesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Genres/{Genres%2Did}/Images", rawUrl) {
        }
    }
}
