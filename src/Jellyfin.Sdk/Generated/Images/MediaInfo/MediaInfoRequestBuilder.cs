// <auto-generated/>
using Jellyfin.Sdk.Generated.Images.MediaInfo.Item;
...
using System;
namespace Jellyfin.Sdk.Generated.Images.MediaInfo {
    /// <summary>
    /// Builds and executes requests for operations under \Images\MediaInfo
    /// </summary>
    public class MediaInfoRequestBuilder : BaseRequestBuilder {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MediaInfoRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Images/MediaInfo", rawUrl) {
        }
        /// <summary>
