...
using System;
namespace Jellyfin.Sdk.Generated.Images.Ratings.Item.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Images\Ratings\{theme}\{name}
    /// </summary>
    public class WithNameItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithNameItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Images/Ratings/{theme}/{name}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithNameItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithNameItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Images/Ratings/{theme}/{name}", rawUrl) {
        }
        /// <summary>
        /// Get rating image.
        /// </summary>
