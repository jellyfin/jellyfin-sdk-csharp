...
#nullable enable
        public async Task<global::Jellyfin.Sdk.Generated.Models.BrandingOptions?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Jellyfin.Sdk.Generated.Models.BrandingOptions> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Jellyfin.Sdk.Generated.Models.BrandingOptions>(requestInfo, global::Jellyfin.Sdk.Generated.Models.BrandingOptions.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets branding configuration.
        /// </summary>
