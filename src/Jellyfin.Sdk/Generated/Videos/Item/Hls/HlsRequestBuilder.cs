...
namespace Jellyfin.Sdk.Generated.Videos.Item.Hls {
    /// <summary>
    /// Builds and executes requests for operations under \Videos\{Videos-id}\hls
    /// </summary>
    public class HlsRequestBuilder : BaseRequestBuilder {
        ...
        public HlsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{Videos%2Did}/hls", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HlsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HlsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{Videos%2Did}/hls", rawUrl) {
        }
    }
}
