...
namespace Jellyfin.Sdk.Generated.Videos.Item.Hls1 {
    /// <summary>
    /// Builds and executes requests for operations under \Videos\{Videos-id}\hls1
    /// </summary>
    public class Hls1RequestBuilder : BaseRequestBuilder {
        ...
        public Hls1RequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{Videos%2Did}/hls1", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new Hls1RequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Hls1RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{Videos%2Did}/hls1", rawUrl) {
        }
    }
}
