...
namespace Jellyfin.Sdk.Generated.Videos.Item.AdditionalParts {
    /// <summary>
    /// Builds and executes requests for operations under \Videos\{Videos-id}\AdditionalParts
    /// </summary>
    public class AdditionalPartsRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new AdditionalPartsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AdditionalPartsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{Videos%2Did}/AdditionalParts{?userId*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AdditionalPartsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AdditionalPartsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{Videos%2Did}/AdditionalParts{?userId*}", rawUrl) {
        }
        /// <summary>
...
#nullable restore
        ...
        public class AdditionalPartsRequestBuilderGetRequestConfiguration : RequestConfiguration<AdditionalPartsRequestBuilderGetQueryParameters> {
        }
    }
}
