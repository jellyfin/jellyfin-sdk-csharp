...
namespace Jellyfin.Sdk.Generated.Videos.Item.Item.Subtitles.Item {
    /// <summary>
    /// Builds and executes requests for operations under \Videos\{itemId-id}\{mediaSourceId-id}\Subtitles\{index-id}
    /// </summary>
    public class IndexItemRequestBuilder : BaseRequestBuilder {
        ...
        public IndexItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{itemId%2Did}/{mediaSourceId%2Did}/Subtitles/{index%2Did}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="IndexItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IndexItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{itemId%2Did}/{mediaSourceId%2Did}/Subtitles/{index%2Did}", rawUrl) {
        }
        /// <summary>
