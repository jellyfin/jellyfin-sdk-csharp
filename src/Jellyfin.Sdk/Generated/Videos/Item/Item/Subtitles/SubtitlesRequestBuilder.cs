...
namespace Jellyfin.Sdk.Generated.Videos.Item.Item.Subtitles {
    /// <summary>
    /// Builds and executes requests for operations under \Videos\{itemId-id}\{mediaSourceId-id}\Subtitles
    /// </summary>
    public class SubtitlesRequestBuilder : BaseRequestBuilder {
        ...
        public IndexItemRequestBuilder this[int position] { get {
        ...
        public SubtitlesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{itemId%2Did}/{mediaSourceId%2Did}/Subtitles", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="SubtitlesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubtitlesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Videos/{itemId%2Did}/{mediaSourceId%2Did}/Subtitles", rawUrl) {
        }
    }
}
