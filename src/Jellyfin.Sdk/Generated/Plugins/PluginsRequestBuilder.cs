...
namespace Jellyfin.Sdk.Generated.Plugins {
    ...
    public class PluginsRequestBuilder : BaseRequestBuilder {
        ...
        public WithPluginItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
...
#nullable restore
        ...
        public class PluginsRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
